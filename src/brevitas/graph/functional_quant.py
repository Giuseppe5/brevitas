...
class _FunctionalReferenceTensor(Tensor):
    ...
    def __getitem__(self, index):
        ...
        return _FunctionalReferenceTensor(
            ...
            self._functional_owner_id,
            (*self._functional_view_indices, index))
...
class FunctionalQuantState:
    ...
    def iter_linear_targets(
            self, module_scope: Optional[nn.Module] = None) -> List[FunctionalLinearTarget]:
...
class _FunctionalQuantBuilder(_HookedMode):
    ...
    @staticmethod
    def _view_indices(
            owner: Tuple[nn.Module, str], value: Tensor,
